                ...
                <tr>
                  <td align="center">
                    <table width="600" cellpadding="0" cellspacing="0" style="background: linear-gradient(135deg, #0a0a0a 0%, #1a1a2e 50%, #0a0a0a 100%); border: 2px solid rgba(34, 211, 238, 0.3); border-radius: 0; box-shadow: 0 0 30px rgba(34, 211, 238, 0.2), inset 0 0 30px rgba(34, 211, 238, 0.05); overflow: hidden; position: relative;">
                      ...
                      <!-- Header -->
                      <tr>
                        <td style="padding: 70px 40px 40px; text-align: center; border-bottom: 2px solid rgba(34, 211, 238, 0.3); position: relative;">
                          <div style="position: absolute; top: 20px; left: 0; width: 100%; height: 2px; background: linear-gradient(90deg, transparent, #22d3ee, transparent);"></div>
                          <h1 style="margin: 0; font-size: 42px; font-weight: 900; color: #06b6d4; background: linear-gradient(135deg, #06b6d4 0%, #22d3ee 50%, #3b82f6 100%); -webkit-background-clip: text; -webkit-text-fill-color: transparent; background-clip: text; letter-spacing: -1px; text-shadow: 0 0 50px rgba(34, 211, 238, 1); position: relative;">
                            Welcome ${fullName},
                          </h1>
